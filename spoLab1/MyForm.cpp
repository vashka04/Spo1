...
System::Void spoLab1::MyForm::btnAnalyze_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    while (fgets(buffer, sizeof(buffer), pipe) != NULL) {
        ...
        if (pos != string::npos) {
            ...
            if (tokenType == "T_VARIABLE" || tokenType == "T_LNUMBER" || tokenType == "T_DNUMBER" || tokenType == "T_CONSTANT_ENCAPSED_STRING") {
                operands[tokenContent]++;
            }
            else if (tokenType == "T_WHITESPACE" || tokenType == "T_COMMENT" || tokenType == "T_DOC_COMMENT" || tokenType == "T_OPEN_TAG" || tokenType == "T_CLOSE_TAG") {
                continue;
            }
            else {
